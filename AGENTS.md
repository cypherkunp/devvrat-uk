...
Issues live in GitHub Issues for `cypherkunp/devvrat-uk` (via `gh`). See `docs/agents/issue-tracker.md`.
...
When writing, moving, splitting, or naming modules, components, or routes. See `docs/agents/clean-code.md`.
