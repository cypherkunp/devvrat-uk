...
export type TileArt = {
  ...
  glyph: ReactNode
  /** Colour of the bloom behind the watermark. */
  glow: string
  /** Colour of the mark inside the chip. */
  accent: string
}
