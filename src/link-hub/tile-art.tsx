...
export type TileArt = {
  /** Oversized mark bled into the tile corner. */
  glyph: ReactNode
  /** Radial wash behind the glyph, in the destination's own colour. */
  tint: string
}
...
function wash(color: string) {
  return `radial-gradient(120% 120% at 100% 100%, ${color}, transparent 62%)`
}

export const tileArt: Record<LinkId | ActionId, TileArt> = {
  email: {
    tint: wash('rgba(250,250,250,0.07)'),
    glyph: (
      <LineGlyph>
  ...
  twitter: {
    tint: wash('rgba(250,250,250,0.08)'),
    glyph: (
  ...
  linkedin: {
    tint: wash('rgba(10,102,194,0.28)'),
    glyph: (
  ...
  'central-hub': {
    tint: wash('rgba(245,158,11,0.26)'),
    glyph: (
      <LineGlyph>
  ...
  photos: {
    tint: wash('rgba(139,92,246,0.22)'),
    glyph: (
      <LineGlyph>
  ...
  'copy-url': {
    tint: wash('rgba(16,185,129,0.20)'),
    glyph: (
      <LineGlyph>
